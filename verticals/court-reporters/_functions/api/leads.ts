...
<div style="max-width:560px;margin:40px auto;background:#fff;border-radius:12px;border:1px solid #e5e7eb;overflow:hidden">
  ...
  <div style="padding:32px">
    ...
    <div style="margin-top:24px">
      <a href="mailto:${escUrl(attorney.email)}?subject=Re:%20Court%20Reporter%20Quote%20Request&body=Hi%20${escUrl(attorney.name)},%0A%0AThank%20you%20for%20your%20interest.%20"
