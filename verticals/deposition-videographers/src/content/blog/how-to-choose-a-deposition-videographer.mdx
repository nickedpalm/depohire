...
image: "/images/blog/how-to-choose-a-deposition-videographer.jpg"
...
**2. Jurisdiction knowledge.** Some states require legal videographers to be authorized to administer an oath — meaning they may need notary, court reporter, or bailiff status for the video to be admissible. This varies state by state. A videographer working depositions in [New York](/locations/new-york/new-york/) faces different rules than one working in [Los Angeles](/locations/california/los-angeles/). If your videographer doesn't know the local requirements, you have a problem you won't discover until trial.
