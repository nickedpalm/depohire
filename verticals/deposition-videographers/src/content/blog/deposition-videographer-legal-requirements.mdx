...
image: "/images/blog/deposition-videographer-legal-requirements.jpg"
...
Most states adopt the federal framework, but the variations are where reality hits hardest. A videographer who works depositions in [Houston](/locations/texas/houston/) faces different requirements than one in [Chicago](/locations/illinois/chicago/) or [Los Angeles](/locations/california/los-angeles/).
...
Here's what most people miss: **the videographer doesn't need to know every state's rules.** But they need to know that state rules vary and they need to ask the right questions before every engagement. A videographer who treats a deposition in [Miami](/locations/florida/miami/) exactly the same as one in [San Francisco](/locations/california/san-francisco/) is a videographer who hasn't done their homework.
